...
const ClassRoomCard: React.FC<ClassRoomCardProps> = ({ room, capacity }) => {
  return (
    <div className="h-fit w-full px-4 py-3 border-[0.5px] border-border bg-white rounded-lg flex flex-col gap-2">
      <div className="flex flex-col gap-3">
        <div className="w-full flex justify-between items-center">
          ...
          {/* Uncomment this block if you want to add a "Change" button */}
          {/* <div className="flex h-fit items-end space-x-1 hover:cursor-pointer hover:scale-105 rounded-lg group">
            <p className="text-text text-md font-medium group-hover:underline group-hover:decoration-[0.7px] group-hover:underline-offset-4">
              Change
            </p>
